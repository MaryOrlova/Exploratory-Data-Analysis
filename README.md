...
Only data from the dates **2007-02-01 and 2007-02-02** is used in scripts, also every script cleans up names of variables and adds column DataTime, that contains both date and time of measurement. 
